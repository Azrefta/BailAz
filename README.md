...
```bash
npm install baileys@github:Azrefta/BailAz
```
...
Found a bug or have a feature request? Open an [issue here](https://github.com/Azrefta/BailAz/issues) and let's improve together!
